...
syn keyword antlrOperations pushMode popMode skip channel type setType
...
if version >= 508
  ...
  HiLink antlrAltLabel		Constant
  HiLink antlrBrace		Identifier
  HiLink antlrBlock		Operator
  HiLink antlrCharacter         Special
  HiLink antlrCharClass         Special
